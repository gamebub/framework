...
# Metadata
########################################
# Set user ID to identify as Game Bub revision 2
set_property BITSTREAM.CONFIG.USERID 0xB0100002 [current_design]
...
set_property -dict { PACKAGE_PIN A1     IOSTANDARD LVCMOS33 } [get_ports { vibrate_brake_n }];
